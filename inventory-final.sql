...
CREATE TABLE `order` (
  ...
  KEY `Order_customerId_fkey_idx` (`customerId`),
...
INSERT INTO `order` VALUES (1,2,6,'Modu Nikhileswar','7396807340','RUGVED AI TECH, 44-41-3/A, Nandagiri Nagar, Akkayapalem, Visakhapatnam','CONFIRMED','COD',NULL,18000,'2025-09-09 15:04:40.062','2025-09-09 15:15:43.067'),(2,2,6,'Modu Nikhileswar','7396807340','RUGVED AI TECH, 44-41-3/A, Nandagiri Nagar, Akkayapalem, Visakhapatnam','PENDING','UPI',NULL,32000,'2025-09-09 15:20:08.807','2025-09-09 15:20:08.807'),(3,2,6,'chandra sekhar M','7396807340','RUGVED AI TECH, 44-41-3/A, Nandagiri Nagar, Akkayapalem, Visakhapatnam','CONFIRMED','COD',NULL,9000,'2025-09-09 15:21:17.025','2025-09-09 15:21:58.912'),(4,2,6,'Modu Nikhileswar','7396807340','radha enclave, akkayyapalem','CONFIRMED','COD',NULL,16000,'2025-09-09 15:49:06.365','2025-09-12 07:46:31.465'),(5,2,6,'Modu Nikhileswar','7396807340','radha enclave, akkayyapalem','CONFIRMED','COD',NULL,24000,'2025-09-09 15:54:54.589','2025-09-12 07:46:27.808'),(6,2,6,'nikhileswar viewer M','7396807340','RUGVED AI TECH, 44-41-3/A, Nandagiri Nagar, Akkayapalem, Visakhapatnam','CONFIRMED','COD',NULL,56000,'2025-09-09 16:14:47.243','2025-09-12 07:46:22.991');
...
INSERT INTO `orderitem` VALUES (1,1,42,4,4500),(2,2,43,4,8000),(3,3,46,6,1500),(4,4,43,2,8000),(5,5,44,2,12000),(6,6,43,7,8000);
...
CREATE TABLE `product` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Product_storeId_sku_key` (`storeId`,`sku`),
...
-- Dump completed on 2025-09-12 13:59:40
